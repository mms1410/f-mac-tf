...
project = "f_mac_tf"
copyright = f"{date.today().year}, Sven Maurice Morlock, Adrian Glos"
author = "Sven Maurice Morlock, Adrian Glos"
...
modindex_common_prefix = ["f_mac_tf."]
...
htmlhelp_basename = "f_mac_tf_doc"
...
texinfo_documents = [
    (
        ...
        "f_mac_tf Documentation",
        author,
        "Sven Maurice Morlock, Adrian Glos",
